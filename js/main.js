...
(function() {
  ...
  const translations = {
    es: {
      ...
      'nav.cowork': 'CoWork & Cafe',
      'nav.about': 'Nosotros',
      'nav.book': 'Reservar',
      'hero.overline': 'Villarrica, Chile',
      'hero.title': 'Despierta frente al Volcan Villarrica',
      'hero.subtitle': 'Un refugio en la naturaleza a orillas del Rio Tolten. Alojamiento, experiencias y eventos en 1 hectarea de bosque nativo.',
      ...
      'section.place.title': 'Donde el bosque se encuentra con el volcan',
      'section.place.text': 'Ubicados en las orillas del Rio Tolten, con vista privilegiada al Volcan Villarrica. Una hectarea de naturaleza, madera nativa y tranquilidad absoluta.',
      ...
      'section.experiences.title': 'Mas que un lugar para dormir',
      'section.weddings.title': 'Tu matrimonio a orillas del rio',
      'section.weddings.text': 'Celebra el dia mas importante en un entorno natural unico. Capacidad para mas de 100 invitados.',
      'section.weddings.cta': 'Conocer mas',
      'section.cowork.overline': 'CoWork & Cafe',
      'section.cowork.title': 'Trabaja con vista al volcan',
      'section.reviews.overline': 'Resenas',
      'section.reviews.title': 'Lo que dicen nuestros huespedes',
      'newsletter.title': 'Mantente conectado',
      'newsletter.text': 'Recibe novedades, ofertas especiales y lo mejor de la Araucania.',
    ...
    en: {
      ...
      'hero.subtitle': 'A nature retreat on the banks of the Tolten River. Accommodation, experiences and events in 1 hectare of native forest.',
      ...
      'section.place.text': 'Located on the banks of the Tolten River, with a privileged view of Villarrica Volcano. One hectare of nature, native wood and absolute tranquility.',
      ...
      'section.weddings.text': 'Celebrate your most important day in a unique natural setting. Capacity for over 100 guests.',
      ...
      'newsletter.text': 'Receive news, special offers and the best of Araucania.',
